            ...
            <div className="navbar  bg-transparent z-10 fixed">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu text-2xl menu-sm text-gray-400 dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                            {links}
                        </ul>
                    </div>
                    <a className="btn btn-ghost text-4xl text-gray-400">daisyUI</a>
                </div>
                <div className="navbar-end w-full">
                    <ul className="menu text-xl font-bold menu-horizontal px-1 text-gray-400">
                        {links}
                    </ul>
                    <div>
                        {
